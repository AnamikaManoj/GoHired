...
function addNewexp() {
    ...
    company.setAttribute("name","company"+wecount)
    ...
    position.setAttribute("name","position"+wecount);
    ...
    desc.setAttribute("name","desc"+wecount);
...
function addNewQual() {
    ...
    course.setAttribute("name","course"+eqcount);
    ...
    institution.setAttribute("name","institution"+eqcount);
    ...
    board.setAttribute("name","board"+eqcount);
    ...
    cgpa.setAttribute("name","cgpa"+eqcount);
...
function addNewProj() {
    ...
    title.setAttribute("name","title"+projcount);
    ...
    desc.setAttribute("name","proj_desc"+projcount);
    desc.setAttribute("placeholder","Add a description");
...
function addNewskill() {
    ...
    select.setAttribute('name',"dash"+skillcount);
    ...
    skill.setAttribute("name","skill"+skillcount);
...
function addNewlang() {
    ...
    lang.setAttribute("name","lang"+langcount);
...
function validate(){
    setCookie("wecount",wecount,10);
    setCookie("eqcount",eqcount,10);
    setCookie("projcount",projcount,10);
    setCookie("langcount",langcount,10);
    setCookie("skillcount",skillcount,10);
