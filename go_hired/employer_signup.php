  ...
  if($password1!=""&&$username!=""&&$email!=""){
    ...
    if(strlen($password1)<8){
      ...
      if($password1==$password2){
        ...
        $sql="insert into users (username,email,password,user_type) values ('". $username ."','". $email ."','". md5($password1) ."','company');";
        $result=mysqli_query($con,$sql);
        if($result){
                        ...
                        <div class="card-body p-md-5">
                            <div class="row justify-content-center">
                                <div class="col-md-10 col-lg-6 col-xl-5 order-2 order-lg-1">
                                    ...
                                    echo'</div>';}
                                     ?>
                                    <form class="mx-1 mx-md-4" method="post" action="employer_signup.php">
